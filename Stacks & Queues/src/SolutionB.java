...
class SiteStats {
     ...
     * 
     * @para an int that represents the number that we want to set numVisits to
     */
...
public class SolutionB {
    ...
    private final static Queue<SiteStats> sites = new LinkedList<>();
    ...
    public static void listTopVisitedSites(Queue<SiteStats> sites, int n) {
        ...
        while(count > 0){        //while loop will sort the queue.
